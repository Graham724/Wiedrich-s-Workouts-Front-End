 ...
 return (
      <div>
        ...
        {/* <Link to={`/deleteRecipe/${recipeID}`}>
          <Button onClick={handleDelete} className='delete-buttons' variant="danger" style={{float: 'left', marginRight: '7px'}}>Delete Recipe</Button>
        </Link> */}
           <Button disabled className='edit-buttons' variant="warning" style={{float: 'left', marginRight: '7px'}}>Edit Recipe</Button>
           <Link to='/recipes'>
            <Button className='back-buttons' variant="info" style={{float: 'left'}}>Back to Recipes</Button>
           </Link>
      </div>
     )    
}